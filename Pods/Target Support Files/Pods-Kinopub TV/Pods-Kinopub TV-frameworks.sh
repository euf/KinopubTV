...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/PMKVObserver/PMKVObserver.framework"
  install_framework "${PODS_ROOT}/Reveal-SDK/RevealServer-8/tvOS/RevealServer.framework"
